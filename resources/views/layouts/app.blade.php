        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href="{{route('tag.index')}}"><i class="fa fa-tag"></i>Tag</a></li>
                    <li><a href="{{route('infografis.index')}}"><i class="fa fa-picture-o"></i> <span>Infografis</span></a></li>
                    <li><a href="{{route('berita.index')}}"><i class="fa fa-newspaper-o"></i> <span>Berita</span></a></li>
                    <li><a href="{{route('pengumuman.index')}}"><i class="fa fa-signal"></i> <span>Pengumuman</span></a></li>
                    <li><a href="{{route('album.index')}}"><i class="fa fa-picture-o"></i> <span>Galeri</span></a></li>
                    <li><a href="{{route('agenda.index')}}"><i class="fa fa-calendar"></i> <span>Agenda</span></a></li>
                    <li><a href="{{route('pegawai.index')}}"><i class="fa fa-user"></i> <span>Pegawai</span></a></li>
                    <li class="treeview">
                        <a href="#">
