    ...
    <div class="column-wrapper light-wrapper no-background " id="column-wrapper-2">
        <div class="container">
            <div class="row row-wrapper" id="column-content-2">
                <div class="col-md-8 main-content" id="main-container-2">
                    <div class="row">
                            ...
                            <div class="category-box box-style11 push_bottom_40" id="pixel_block_2_1">
                                <div class="box-title">
                                    ...
                                    <div class="alignright box-actions">
                                        <ul class="box-btns">
                                            <li><a href="#" data-id="3" class="category-box-btn">Sekretariat</a></li>
                                            <li><a href="#" data-id="4" class="category-box-btn">Bidang I</a></li>
                                            <li><a href="#" data-id="7" class="category-box-btn">Bidang II</a></li>
                                            <li><a href="#" data-id="8" class="category-box-btn">Bidang III</a></li>
                                            <li><a href="#" data-id="8" class="category-box-btn">Bidang IV</a></li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="widget widget_search push_bottom_30" id="search-2">
                    <form role="search" method="get" action="https://pixellab-themes.com/bayan/" class="search-form">
                    ...
                    <div class="panel-group">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane box-content row active" id="recent_widget_tabs-2">
                                ...
                                <article class="article other-article side-article col-md-12">
                                    <div class="article-image">
                                        <a href="{{route('berita.show', $b->slug)}}" title="Traffic: a Lot of Cars Driving Across The Golden Gate Bridge">
                            ...
                            <div class="tab-pane box-content row" id="popular_widget_tabs-2">
                                ...
                                <article class="article other-article side-article col-md-12">
                                    <div class="article-image">
                                        <a href="{{route('berita.show', $b2->slug)}}" title="Fearless Man Challenge Everything Pose">
                    ...
                    <div class="row">
                        ...
                        <section class="col-sm-6 ">
                            <div class="widget widget_categories push_bottom_30" id="categories-3"><h3 class="widget-title"><span>Agenda</span></h3>
                                <ul>
                                    <li class="cat-item cat-item-2"><a href="https://pixellab-themes.com/bayan/category/nature/animals/">Animals</a></li>
                                </ul>
                            </div>
                        </section>
                    </div>
