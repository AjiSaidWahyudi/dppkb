...
<head>
	...
	<title>Informasi Masuknya Kegiatan</title>
					...
					<tr>
						<td class="container-padding content" align="left">
							...
							<div class="body-text">
								Kegiatan Anda:
								<br>
								<center><label class="label label-info text-center"><strong>{{ $kegiatan->nama }}</strong></label></center>
								<br><br>
								<br>
								Telah berhasil diinput.
								<br>
								<br>
								<strong>Dalam waktu dekat, kegiatan ini akan segera dijalankan, terima kasih</strong>
								<br>
								<br>
								<br>
								Hormat Kami,
