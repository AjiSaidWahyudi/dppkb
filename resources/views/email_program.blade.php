					...
					<tr>
						<td class="container-padding content" align="left">
							...
							<div class="body-text">
								Program Anda:
								<br>
								<center><label class="label label-info text-center"><strong>{{ $program->nama }}</strong></label></center>
								<br><br>
								<br>
								Telah berhasil diinput.
								<br>
								<br>
								<strong>Dalam waktu dekat, program ini akan segera dijalankan, terima kasih</strong>
								<br>
								<br>
								<br>
								Hormat Kami,
