                            ...
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="label label-success" value="{{$sub->status}}">Sudah Terlaksana</span>
                                        @else
                                        <span class="label label-danger" value="{{$sub->status}}">Belum Terlaksana</span>
                                        @endif
                                    </td>
                                    <td>{{$sub->detail}}</td>
                                    <td>
                                        <form action="{{route('subkeg.destroy', $sub->id)}}" method="post">
                                            <div class="btn-group">
                                                <a href="{{route('subkeg.show', $sub->slug)}}" type="button" class="btn btn-primary" target="_blank"><i class="fa fa-eye"></i></a>
